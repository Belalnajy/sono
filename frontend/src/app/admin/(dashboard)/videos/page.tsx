...
import { Plus, Trash2, ArrowRight, LayoutDashboard, Video as VideoIcon, X, Smartphone } from 'lucide-react';
...
export default function VideosManagement() {
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ title: '', description: '', video_url: '', categoryId: '', subcategoryId: '' });
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-8 flex items-center justify-between">
            <div className="flex items-center gap-2 text-gray-500 text-sm">
                <Link href="/admin/dashboard" className="hover:text-primary-600 transition-colors flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {videos.map((video) => (
            <div key={video.id} className="bg-white rounded-2xl shadow-elegant overflow-hidden hover:shadow-premium transition-all group border border-gray-100">
              ...
              <div className="p-5">
                <div className="flex items-start justify-between mb-2">
                    ...
                    <span className="bg-primary-50 text-primary-700 text-xs px-2 py-1 rounded-full font-bold whitespace-nowrap">{video.category?.name}</span>
                </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl animate-fade-in-down max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
                 <h2 className="text-2xl font-bold text-gray-900">إضافة فيديو جديد</h2>
            ...
            <form onSubmit={handleAdd} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button type="submit" className="flex-1 bg-primary-600 hover:bg-primary-700 text-white px-4 py-3 rounded-xl font-medium transition-colors shadow-lg shadow-primary-600/20">
                  حفظ
                </button>
                <button
                  type="button"
