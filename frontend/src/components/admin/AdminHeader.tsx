    ...
    <header className="bg-white shadow-sm border-b border-gray-100 h-20 px-6 flex items-center justify-between sticky top-0 z-30">
        ...
        <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-bold text-gray-800 hidden md:block">
                مرحباً بك، <span className="text-primary-600">{user?.username || 'Admin'}</span> 👋
            </h2>
        </div>
        ...
        <div className="flex items-center gap-4">
            ...
            {/* Notifications */}
            <button className="relative p-2.5 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 text-gray-600 transition-colors">
            ...
            <div className="flex items-center gap-3 pl-2 border-r border-gray-100 mr-2 pr-2">
                ...
                <div className="hidden md:block">
                    <p className="text-sm font-bold text-gray-800 leading-tight">{user?.username || 'Admin'}</p>
